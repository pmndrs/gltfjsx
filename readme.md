...
The usual GLTF workflow makes later modifications cumbersome since you have to traverse the data. With gltfjsx the full graph is under your control, you can add shadows, events, change materials, make contents conditional, etc.
